...
import scrapy
from Grocery.items import GroceryLoader, RiceItem

class RiceSpider(scrapy.Spider):
    name = 'rice'
    
    start_urls = ['https://eshop.tesco.com.my/groceries/en-GB/shop/grocery/rice/all']
    ...
    def parse_product(self, response):
        l = GroceryLoader(item=RiceItem(), response=response)
